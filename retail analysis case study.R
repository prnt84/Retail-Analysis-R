...
library(dplyr)
#question 1
Customer <- read.csv("D:/praneeta/praneeta/ALABS/R/R case study 1 (Retail)/Customer.csv")
Transactions <- read.csv("D:/praneeta/praneeta/ALABS/R/R case study 1 (Retail)/Transactions.csv")
prod_cat_info <- read.csv("D:/praneeta/praneeta/ALABS/R/R case study 1 (Retail)/prod_cat_info.csv")
